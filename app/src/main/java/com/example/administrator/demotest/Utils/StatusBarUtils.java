...
import com.example.administrator.demotest.activity.MainActivity;
...
//            ViewGroup winContent = (ViewGroup) activity.getWindow().getDecorView().findViewById(android.R.id.content);

            ViewGroup winContent = (ViewGroup) activity.findViewById(android.R.id.content);
//            ViewGroup winContent = (ViewGroup) activity.findViewById(android.R.id.content).getRootView();
    ...
    public static boolean checkDeviceHasNavigationBar(Context context) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e(TAG, "checkDeviceHasNavigationBar: " + e.getMessage());
        }
