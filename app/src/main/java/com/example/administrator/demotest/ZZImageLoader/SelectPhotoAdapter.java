package com.example.administrator.demotest.ZZImageLoader;
...
import com.example.administrator.demotest.Utils.AlxMultiTask;
...
public class SelectPhotoAdapter extends ArrayAdapter<SelectPhotoAdapter.SelectPhotoEntity> implements View.OnClickListener {
    ...
    private File mfile1;
    private ZZImageLoder alxImageLoader;
    ...
    public SelectPhotoAdapter(Activity activity, ArrayList<SelectPhotoEntity> array) {
        ...
        this.alxImageLoader = new ZZImageLoder(activity);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {//第一个位置显示一个小相机
            ...
            viewHolder.rlPhoto.setOnClickListener(new View.OnClickListener() {
     ...
     * @return
     */
    public HashSet<SelectPhotoEntity> selectedPhotosSet = new HashSet<>(9);
